  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-white rounded-3xl border border-gray-200 shadow-sm p-8">
        ...
        <p className="text-sm text-gray-500 mb-8">Access your account and start selling safely.</p>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link to={`/register?next=${encodeURIComponent(next)}`} className="font-semibold text-jiji-orange hover:text-[#E65A00]">
            Register
          </Link>
        </p>
      </div>
